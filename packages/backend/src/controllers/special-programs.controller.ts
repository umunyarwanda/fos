  ...
  static async updateSpecialProgram(req: Request, res: Response): Promise<void> {
    try {
      ...
      const response: IGetSpecialProgramResDto = {
        ...
        startDate: updatedProgram.startDate ? dayjs(updatedProgram.startDate).format('DD MMM YYYY') : null,
        endDate: updatedProgram.endDate ? dayjs(updatedProgram.endDate).format('DD MMM YYYY') : null,
